package com.wrecker.sampleweather.listener;
...
/**
 * Created by xiaoxin on 2016/8/21.
 */
public class MyLocationListener implements BDLocationListener {
    ...
    public void onReceiveLocation(BDLocation location) {
        //Receive Location
        //注意，请使用真机，且插上SIM卡。在虚拟机上无法进行定位测试。
        ...
        Constances.setCity(location.getCity());

        synchronized (Constances.getCity()) {
            Constances.setCity(location.getCity());
            Constances.getCity().notifyAll();
